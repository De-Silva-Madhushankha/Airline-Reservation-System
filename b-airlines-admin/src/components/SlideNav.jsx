        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <ul className="space-y-2 font-medium">
                    ...
                    <ul id="dropdown-example" className="hidden group-hover:block space-y-1 text-sm">
                        <li>
                            <button onClick={() => setActiveSection("report1")} 
                                    className="flex items-center w-full text-left text-gray-900 transition duration-75 rounded-lg pl-4 py-2 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                Below/Over age 18
                            </button>
                        </li>
                        <li>
                ...
                <li>
                    <button
                        onClick={() => {
                        // Any logout logic here (e.g., clearing tokens)
                        navigate('/');
                        }}
